...
public class TokenizerTest extends TestCase {
	...
	public void testFullTemplate() {
		...
		try {
			...
			String[] regions = new String[] { "XML_DECLARATION_OPEN", "XML_DOCTYPE_DECLARATION", "XML_DOCTYPE_NAME",
					"XML_DECLARATION_CLOSE", "XML_CONTENT", "XML_TAG_OPEN", "XML_TAG_NAME", "XML_TAG_CLOSE",
					...
					"XML_EMPTY_TAG_CLOSE", "XML_CONTENT", "XML_TAG_OPEN", "XML_TAG_NAME", "XML_TAG_CLOSE",
					"TWIG_STMT_OPEN", "TWIG_CONTENT", "TWIG_STMT_CLOSE", "XML_CONTENT", "TWIG_STMT_OPEN",
					"TWIG_CONTENT", "TWIG_STMT_CLOSE", "XML_END_TAG_OPEN", "XML_TAG_NAME", "XML_TAG_CLOSE",
					...
					"XML_CONTENT", "TWIG_OPEN", "TWIG_CONTENT", "TWIG_CLOSE", "XML_CONTENT", "TWIG_COMMENT_OPEN",
					"TWIG_COMMENT", "TWIG_COMMENT_CLOSE", "XML_CONTENT", "XML_END_TAG_OPEN", "XML_TAG_NAME",
	...
	public void testMultiParams() {
		...
		try {
			...
			assertEquals(scriptRegion.getTwigToken(0).getType(), TwigRegionContext.TWIG_LABEL);
			assertEquals(scriptRegion.getTwigToken(1).getType(), TwigRegionContext.TWIG_LABEL);
			assertEquals(scriptRegion.getTwigToken(6).getType(), TwigRegionContext.TWIG_CONSTANT_ENCAPSED_STRING);
			assertEquals(scriptRegion.getTwigToken(16).getType(), TwigRegionContext.TWIG_CONSTANT_ENCAPSED_STRING);
	...
	public void testEmbeddedBlockStatement() {
		...
		try {
			...
			regions = new String[] { "XML_TAG_OPEN", "XML_TAG_NAME", "XML_TAG_ATTRIBUTE_NAME",

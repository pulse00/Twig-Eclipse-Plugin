...
public class TokenizerTest extends TestCase {
	...
	public void testFullTemplate() {
		...
		try {
			...
			String[] regions = new String[] {"XML_DECLARATION_OPEN", "XML_DOCTYPE_DECLARATION", 
					"XML_DOCTYPE_NAME", "XML_DECLARATION_CLOSE", "XML_CONTENT", "XML_TAG_OPEN", 
					...
					"XML_CONTENT", "XML_END_TAG_OPEN", "XML_TAG_NAME", "XML_TAG_CLOSE", "XML_CONTENT", "XML_TAG_OPEN", 
					"XML_TAG_NAME", "XML_TAG_CLOSE", "XML_CONTENT", "XML_TAG_OPEN", "XML_TAG_NAME", "XML_TAG_ATTRIBUTE_NAME", 
					"XML_TAG_ATTRIBUTE_EQUALS", "XML_TAG_ATTRIBUTE_VALUE", "XML_TAG_CLOSE", "XML_CONTENT", "TWIG_OPEN", 
					"TWIG_CONTENT", "TWIG_CLOSE", "XML_END_TAG_OPEN", "XML_TAG_NAME", "XML_TAG_CLOSE", "XML_CONTENT", 
					"TWIG_STMT_OPEN", "TWIG_CONTENT", "TWIG_STMT_CLOSE", "TWIG_STMT_OPEN", "TWIG_CONTENT", "TWIG_STMT_CLOSE", 
					"XML_CONTENT", "TWIG_STMT_OPEN", "TWIG_CONTENT", "TWIG_STMT_CLOSE", "TWIG_STMT_OPEN", "TWIG_CONTENT", 
					"TWIG_STMT_CLOSE", "XML_CONTENT", "XML_TAG_OPEN", "XML_TAG_NAME", "XML_TAG_ATTRIBUTE_NAME", 
					"XML_TAG_ATTRIBUTE_EQUALS", "XML_TAG_ATTRIBUTE_VALUE", "XML_TAG_CLOSE", "XML_END_TAG_OPEN", 
					"XML_TAG_NAME", "XML_TAG_CLOSE", "XML_CONTENT", "TWIG_OPEN", "TWIG_CONTENT", "TWIG_CLOSE", 
					"XML_CONTENT", "TWIG_COMMENT_OPEN", "TWIG_COMMENT", "TWIG_COMMENT_CLOSE", "XML_CONTENT", "XML_END_TAG_OPEN", 

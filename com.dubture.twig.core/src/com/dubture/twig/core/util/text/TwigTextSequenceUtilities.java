...
public class TwigTextSequenceUtilities
{
    ...
    /**
     * 
     * Checks if a {@link ContextRegion} type is a Twig region.
     * {@link ContextRegion}
     * 
     * @param context
     * @return
    ...
    public static int readIdentifierStartIndex(TextSequence textSequence,
            int startPosition)
    {
    ...
    /**
     * 
     * Return the previous variable in a statement like {{ form. <-- returns
     * "form"
     * 
     * @param statement
     * @return
    ...
    public static String getVariable(TextSequence statement)
    {
        ...
        while (startOffset > 0) {
            ...
            if (dotOffset > -1 && (Character.isWhitespace(current)) /*
                                                                     * ||
                                                                     * current
                                                                     * == '.'
                                                                     */) {
        ...
        if (dotOffset > -1) {
            return statement.toString().substring(startOffset, dotOffset)
                    .toString();
        }

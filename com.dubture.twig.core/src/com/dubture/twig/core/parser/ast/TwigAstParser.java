...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Jan 05 17:47:03 CET 2012
  */
public class TwigAstParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\006\000\006\007\006\010\004\001\002\000\004\002" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\006\000\006\002\006\003\004\001\001\000\002\001" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$TwigAstParser$act_num)
		...
		String i = (String)((java_cup.runtime.Symbol) CUP$TwigAstParser$stack.peek()).value;
		 RESULT = i; 
              CUP$TwigAstParser$result = parser.getSymbolFactory().newSymbol("term",1, ((java_cup.runtime.Symbol)CUP$TwigAstParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$TwigAstParser$stack.peek()), RESULT);
            }
		...
		String start_val = (String)((java_cup.runtime.Symbol) CUP$TwigAstParser$stack.elementAt(CUP$TwigAstParser$top-1)).value;
		RESULT = start_val;
		...
		String t = (String)((java_cup.runtime.Symbol) CUP$TwigAstParser$stack.peek()).value;
		 RESULT = new String(t); System.out.println("create term"); 
              CUP$TwigAstParser$result = parser.getSymbolFactory().newSymbol("expr",0, ((java_cup.runtime.Symbol)CUP$TwigAstParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$TwigAstParser$stack.peek()), RESULT);
            }
          return CUP$TwigAstParser$result;

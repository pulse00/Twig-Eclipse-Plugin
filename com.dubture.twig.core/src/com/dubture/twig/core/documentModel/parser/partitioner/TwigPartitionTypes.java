 ...
 *      partitioner/SmartyPartitionTypes.java
 * 
 */
...
public class TwigPartitionTypes
{
    ...
    public final static String[] configuredPartitions = new String[]{
            TWIG_DEFAULT, TWIG_COMMENT_TEXT, TWIG_STRING, TWIG_QUOTED_STRING};

    public static boolean isTwigPartition(String regionType)
    {
        return regionType == TWIG_DEFAULT || regionType == TWIG_COMMENT_TEXT
                || regionType == TWIG_STRING
                || regionType == TWIG_QUOTED_STRING;
    }
    ...
    {
        return type == TwigPartitionTypes.TWIG_QUOTED_STRING
                || type == TwigRegionContext.TWIG_CONSTANT_ENCAPSED_STRING;

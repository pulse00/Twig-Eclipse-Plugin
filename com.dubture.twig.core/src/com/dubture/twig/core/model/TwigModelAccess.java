...
public class TwigModelAccess extends PhpModelAccess {
	...
	public Function[] getFunctions(IScriptProject scriptProject) {
		...
		engine.search(ITwigModelElement.FUNCTION, null, null, 0, 0, 100, SearchFor.REFERENCES, MatchRule.PREFIX, scope,
	...
	public Filter[] getFilters(IScriptProject scriptProject) {
		...
		engine.search(ITwigModelElement.FILTER, null, null, 0, 0, 100, SearchFor.REFERENCES, MatchRule.PREFIX, scope,
				new ISearchRequestor() {
	...
	public Tag[] findTags(IScriptProject scriptProject) {
		...
		engine.search(ITwigModelElement.START_TAG, null, null, 0, 0, 200, SearchFor.REFERENCES, MatchRule.PREFIX, scope,
				new ISearchRequestor() {
		...
		engine.search(ITwigModelElement.END_TAG, null, null, 0, 0, 200, SearchFor.REFERENCES, MatchRule.PREFIX, scope,
				new ISearchRequestor() {
	...
	public Test[] getTests(IScriptProject scriptProject) {
		...
		engine.search(ITwigModelElement.TEST, null, null, 0, 0, 100, SearchFor.REFERENCES, MatchRule.PREFIX, scope,
				new ISearchRequestor() {
	...
	public List<BlockName> findBlocks(SourceModule sourceModule, IScriptProject scriptProject) {
		...
		ISearchRequestor requestor = new ISearchRequestor() {
			...
			public void match(int elementType, int flags, int offset, int length, int nameOffset, int nameLength,
					String elementName, String metadata, String doc, String qualifier, String parent,
					ISourceModule sourceModule, boolean isReference) {
				BlockName blockName = new BlockName(sourceModule, elementName, offset, offset + length, offset,
						offset + length, "block");
		...
		engine.search(ITwigModelElement.BLOCK, null, null, 0, 0, 200, SearchFor.REFERENCES, null, scope, requestor,
				null);
		return blocks;
	}
}

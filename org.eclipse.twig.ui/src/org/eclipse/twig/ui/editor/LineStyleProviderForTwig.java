...
public class LineStyleProviderForTwig extends AbstractLineStyleProvider
...
//	}	
	...
	protected TextAttribute getAttributeFor(ITextRegion region) {
		...
		final String stype = region.getType();
		if (stype != null && stype.startsWith("TWIG_")) {
			return getAttributeFor(stype);
		}

...
public class PreferenceConstants {
	...
	public static final String EDITOR_HASH_DEFAULT_COLOR = ColorHelper.getColorString(0, 130, 130);

	public static final String EDITOR_KEYWORD_DEFAULT_COLOR = ColorHelper
			.packStylePreferences(new String[] { ColorHelper.getColorString(127, 0, 85), null, "true" });
	 ...
	 */
	public static final String EDITOR_TEXT_HOVER_MODIFIERS = TwigUICorePlugin.PLUGIN_ID + "hoverModifiers"; //$NON-NLS-1$
	...
	public static String getEnabledPreferenceKey(String preferenceKey) {
		String key = PreferenceConstants.EDITOR_SEMANTIC_HIGHLIGHTING_PREFIX + preferenceKey

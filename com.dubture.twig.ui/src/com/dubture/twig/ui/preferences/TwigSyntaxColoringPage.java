...
public class TwigSyntaxColoringPage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	private OverlayKey[] createOverlayStoreKeys() {
		...
		// for (AbstractSemanticHighlighting rule :
		// SemanticHighlightingManager.getInstance().getSemanticHighlightings().values())
		// {
		//
		// overlayKeys.add(new
	...
	private void initStyleToDescriptionMap() {
		fStyleToDescriptionMap.put(PreferenceConstants.EDITOR_NORMAL_COLOR, "Normal");
		fStyleToDescriptionMap.put(PreferenceConstants.EDITOR_BOUNDARYMARKER_COLOR, "Print tags");
		fStyleToDescriptionMap.put(PreferenceConstants.EDITOR_STMT_BOUNDARYMARKER_COLOR, "Block tags");
		fStyleToDescriptionMap.put(PreferenceConstants.EDITOR_BLOCKNAME_COLOR, "Block name");
		...
		// "Double quotes");
		fStyleToDescriptionMap.put(PreferenceConstants.EDITOR_HASH_COLOR, "Hash Braces");
		fStyleToDescriptionMap.put(PreferenceConstants.EDITOR_KEYWORD_COLOR, "Keyword");
		fStyleToDescriptionMap.put(PreferenceConstants.EDITOR_STRING_COLOR, "String");
		fStyleToDescriptionMap.put(PreferenceConstants.EDITOR_NUMBER_COLOR, "Number");
		fStyleToDescriptionMap.put(PreferenceConstants.EDITOR_COMMENT_COLOR, "Comment");
		fStyleToDescriptionMap.put(PreferenceConstants.EDITOR_INTERPOLATION_COLOR, "String Interpolation");
	...
	private String getNamedStyleAtOffset(int offset) {
		...
		for (Iterator iterator = highlightingPositionMap.keySet().iterator(); iterator.hasNext();) {
			...
			if (interest.getType() == TwigRegionContext.TWIG_CONTENT) {
				...
				try {
					regionContext = phpScript
							.getTwigTokenType(offset - container.getStartOffset() - phpScript.getStart());
